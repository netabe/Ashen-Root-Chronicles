...
var Space = {	
	...
	onArrival: function() {
		...
		// 杂灵根隐藏天赋：混沌道体
		if (!$SM.hasPerk('mixedRoot5')) {
			$SM.addPerk('mixedRoot5');
			$('body').addClass('cultivation-breakthrough');
			setTimeout(function() { $('body').removeClass('cultivation-breakthrough'); }, 2000);
			Notifications.notify(null, '踏入灵界！杂灵根终极天赋"混沌道体"觉醒！');
		}
